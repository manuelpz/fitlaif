...
export default function EntrenamientoFuncion() {
  ...
  return (
    <div className='container mx-auto'>
      <Headers title='Entrenamiento' description='Entrenamiento personalizado' />
      ...
      <div className='grid grid-cols-2 gap-2 justify-center'>
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 justify-self-center text-center">
          ...
          <Link href={`/entrenamientos/generar/${entrenamientos?.musculo}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center justify-self-center">
          ...
          <Link href={`/entrenamientos/personalizado/${entrenamientos?.musculo}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
